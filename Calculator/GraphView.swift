...
class GraphView: UIView {
    ...
    @IBInspectable
    var scale: CGFloat = CGFloat(Constants.Drawing.pointsPerUnits) { didSet { setNeedsDisplay() } }
    ...
    private let drawer = AxesDrawer(color: UIColor.black)
    ...
    private func pathForFunction() -> UIBezierPath {
        ...
        for pixel in  0...width {
            ...
            if let y = data.getYCoordinate((point.x - origin.x)/scale) {
                ...
                // As the orgin ( of the view coordinate system) is upper left and units are points, not pixels
    ...
    func move(_ recognizer: UIPanGestureRecognizer) {
        ...
        case .ended:
            ...
            //Update anytihg thtat depaends on the pan gesture using translation.x and translation.y
            origin.x += translation.x
            origin.y += translation.y
            //Cumulative since start of recognition , get 'inccremental' translation
